...
export type Bill = { id: string; billNumber: string; status: "OPEN" | "CLOSED"; printedAt?: string | null; closedAt?: string | null; createdAt: string; updatedAt: string; tableId?: string | null; table?: RestaurantTable | null; orderNumber: string; orderCount: number; paymentStatus: string; subtotal: number | string; discountAmount: number | string; taxAmount: number | string; totalAmount: number | string; customer?: { name: string } | null; items: OrderItem[]; payments?: OrderPayment[] };
