...
export const DEFAULT_PRINTER_CONFIG: PrinterConfig = { id: "default", name: "XP-C2008", model: "XP-C2008", connection: "USB", paperWidth: 58, autoPrint: false, copies: 1, encoding: "ascii", endpoint: "", token: "" };
